...
// cmd/openbrain-mcp's. openbrain-telegram is a stub today (no config load in
...
func TestPrintVersion(t *testing.T) {
	...
	version.Version = "v0.0.0-telegram-version-flag-test"

	var buf bytes.Buffer
	printVersion(&buf)

	want := "v0.0.0-telegram-version-flag-test\n"
