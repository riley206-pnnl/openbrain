...
// cmd/openbrain-mcp's, and that it never needs config.MustLoad (no env
// required): the whole point of a self-identifying binary the installer can
// query on a fresh host.
...
func TestPrintVersion(t *testing.T) {
	...
	version.Version = "v0.0.0-watchd-version-flag-test"

	var buf bytes.Buffer
	printVersion(&buf)

	want := "v0.0.0-watchd-version-flag-test\n"
